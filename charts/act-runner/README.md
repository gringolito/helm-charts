...
This chart can be used to deploy Act Runners for Gitea.

![Version: 0.1.0](https://img.shields.io/badge/Version-0.1.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.2.11](https://img.shields.io/badge/AppVersion-0.2.11-informational?style=flat-square)
...
* <https://github.com/gringolito/act-runner-helm>
...
| persistence.existingClaim | string | `""` | Name of an existing PersistentVolumeClaim to use instead of creating a new one. |
...
| replicas | string | `"1"` | Number of runner replicas. Only one replica is supported as runner doesn't support clustering. |
...
| runner.updateStrategy.type | string | `"RollingUpdate"` | Specify the deployment used to replace old Pods by new ones valid options are `RollingUpdate`, `Recreate`. [strategy](https://kubernetes.io/docs/concepts/workloads/controllers/deployment/#strategy) |
